...
AI gật đầu. Trong vòng 2 phút, mình có một màn hình subscription hoàn chỉnh. Weekly plan, Monthly plan, Annual plan. UI đẹp. Logic chạy ổn.

Nhưng sau khi test thật, mình mới nhận ra: **AI viết đúng những gì mình nói, nhưng sai hoàn toàn những gì mình cần.**

Tier "Weekly" mình thêm vào cho có — thực ra user không cần nó. Notify 3 ngày trước là quá sớm, phải là 1 ngày. Và cái "tự renew" thì cần xử lý cả edge case khi payment fail...

AI không biết điều đó. Vì mình chưa nói với nó.

---

### 1. Cái bẫy "Copy-Paste yêu cầu từ Slack vào AI"
...
> 👉 **[Tập 4 — Làm UX/UI Designer: User Không Cần UI Đẹp, Họ Cần UI Dễ Dùng](#)**
